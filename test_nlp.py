...
def test_segment_message():
    ...
    assert segment_message("1hr")[0] == {'type': 'requested_alarm_time', 'payload': {"time": datetime(2000, 1, 1, 19, 0, tzinfo=utc), "am_pm_defined": False, "needs_tz_convert": False}, "raw": "1hr"}
    assert segment_message("1 hour")[0] == {'type': 'requested_alarm_time', 'payload': {"time": datetime(2000, 1, 1, 19, 0, tzinfo=utc), "am_pm_defined": False, "needs_tz_convert": False}, "raw": "1 hour"}
    assert segment_message("2hr")[0] == {'type': 'requested_alarm_time', 'payload':  {"time": datetime(2000, 1, 1, 20, 0, tzinfo=utc), "am_pm_defined": False, "needs_tz_convert": False}, "raw": "2hr"}
    assert segment_message("10 min")[0] == {'type': 'requested_alarm_time', 'payload': {"time": datetime(2000, 1, 1, 18, 10, tzinfo=utc), "am_pm_defined": False, "needs_tz_convert": False}, "raw": "10 min"}
    ...
    assert segment_message("Remind me at 1pm.")[0] == {'type': 'requested_alarm_time', 'payload': {"time": datetime(2000, 1, 1, 13, 0, tzinfo=utc), "am_pm_defined": True, "needs_tz_convert": True}, "raw": "Remind me at 1pm."}
    assert segment_message("Thank you! 5 minutes")[0] == {'type': 'requested_alarm_time', 'payload': {"time": datetime(2000, 1, 1, 18, 5, tzinfo=utc), "am_pm_defined": False, "needs_tz_convert": False}, "raw": "Thank you! 5 minutes"}
    ...
    assert segment_message("3 \"Making Chicken Enchiladas\" :-)")[0] == {'payload': '3', 'raw': '3 "Making Chicken Enchiladas" :-)', 'type': 'special'}
