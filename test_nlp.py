...
def test_segment_message():
    ...
    assert segment_message("taken @ 12:15")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 31, 0, 15)), "raw": "taken @ 12:15"}
    ...
    assert segment_message("T at 8:00")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 20, 0)), "raw": "T at 8:00"}
    assert segment_message("T at 8")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 20, 0)), "raw": "T at 8"}
    assert segment_message("T at8")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 20, 0)), "raw": "T at8"}
    assert segment_message("T@8")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 20, 0)), "raw": "T@8"}
    assert segment_message("Taken@ 8")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 20, 0)), "raw": "Taken@ 8"}
    assert segment_message("T at 12:30")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 31, 0, 30)), "raw": "T at 12:30"}
    assert segment_message("T at 1:30pm")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 31, 1, 30)), "raw": "T at 1:30pm"}
    ...
    assert segment_message("T @ 0759")[0] == {'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 30, 19, 59)), "type": "take", "raw": "T @ 0759"}
...
def test_am_pm_scheduling():
    pacific_time = timezone(USER_TIMEZONE)
    assert segment_message("taken @ 9")[0] == {'type': 'take', 'modifiers': {'emotion': 'neutral'}, 'payload': pacific_time.localize(datetime(1999, 12, 31, 21, 0)), "raw": "taken @ 9"}
