...
RECOGNIZED_ACTIVITIES = {
    "brunch": {"type": "long", "response": f"{COMPUTING_PREFIX} Have a great brunch! We'll check in later."},
    "dinner": {"type": "long", "response": f"{COMPUTING_PREFIX} Have a great dinner! We'll check in later."},
    "lunch": {"type": "long", "response": f"{COMPUTING_PREFIX} Have a great lunch! We'll check in later."},
    "breakfast": {"type": "long", "response": f"{COMPUTING_PREFIX} Have a great breakfast! We'll check in later."},
    "eating": {"type": "long", "response": f"{COMPUTING_PREFIX} Enjoy your meal! We'll check in later."},
    "meeting": {"type": "long", "response": f"{COMPUTING_PREFIX} Have a productive meeting! We'll check in later."},
    "out": {"type": "long", "response": f"{COMPUTING_PREFIX} No problem, we'll check in later."},
    "busy": {"type": "long", "response": f"{COMPUTING_PREFIX} No problem, we'll check in later."},
    "later": {"type": "long", "response": f"{COMPUTING_PREFIX} No problem, we'll check in later."},
    "reading": {"type": "long", "response": f"{COMPUTING_PREFIX} Enjoy your book, we'll check in later."},
    "sleeping": {"type": "long", "response": f"{COMPUTING_PREFIX} Sleep well! We'll see you later."},
    "golf": {"type": "long", "response": f"{COMPUTING_PREFIX} Have fun out there! We'll see you later."},
    "tennis": {"type": "long", "response": f"{COMPUTING_PREFIX} Have fun out there! We'll see you later."},
    "swimming": {"type": "long", "response": f"{COMPUTING_PREFIX} Have fun out there! We'll see you later."},
    "basketball": {"type": "long", "response": f"{COMPUTING_PREFIX} Have fun out there! We'll see you later."},
    "tv": {"type": "long", "response": f"{COMPUTING_PREFIX} Have fun, we'll check in later."},
    "working": {"type": "long", "response": f"{COMPUTING_PREFIX} No problem, we'll check in later."},
    "walking": {"type": "short", "response": f"{COMPUTING_PREFIX} Enjoy your walk! We'll check in later."},
    "walk": {"type": "short", "response": f"{COMPUTING_PREFIX} Enjoy your walk! We'll check in later."},
    "bathroom": {"type": "short", "response": f"{COMPUTING_PREFIX} No problem, we'll check in in a bit."},
    "run":  {"type": "short", "response": f"{COMPUTING_PREFIX} Have a great run! We'll see you later."},
    "running":  {"type": "short", "response": f"{COMPUTING_PREFIX} Have a great run! We'll see you later."},
    "basketball":  {"type": "short", "response": f"{COMPUTING_PREFIX} Have fun out there! We'll see you later."},
    "shower":  {"type": "short", "response": f"{COMPUTING_PREFIX} No problem, we'll check in later."},
    "phone": {"type": "short", "response": f"{COMPUTING_PREFIX} Have a great call! We'll check in later."},
    "call": {"type": "short", "response": f"{COMPUTING_PREFIX} Have a great call! We'll check in later."},
}
