...
class User(db.Model):
    ...
    events = db.relationship("EventLog", backref="user", order_by="asc(EventLog.event_time)", passive_deletes=True)
...
class DoseWindow(db.Model):
    ...
    events = db.relationship("EventLog", backref="dose_window", order_by="asc(EventLog.event_time)")
...
class Medication(db.Model):
    ...
    events = db.relationship("EventLog", backref="medication", order_by="asc(EventLog.event_time)")
