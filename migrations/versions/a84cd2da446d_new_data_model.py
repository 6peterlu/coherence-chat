...
Revision ID: a84cd2da446d
Revises: 412d769b5eef
Create Date: 2021-04-25 16:28:20.915271
...
def upgrade():
    ...
    op.create_foreign_key('dose_medication_linker_dose_window_fkey_custom', 'dose_medication_linker', 'medication', ['medication_id'], ['id'], ondelete='CASCADE')
